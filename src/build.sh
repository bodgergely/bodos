...
rm -rf $BUILD_DIR
mkdir -p $BUILD_DIR
i686-elf-as outb.s -o $BUILD_DIR/outb.o
...
#link the kernel
i686-elf-gcc -T linker.ld -o $BUILD_DIR/bodos.bin -ffreestanding -O2 -nostdlib $BUILD_DIR/boot.o $BUILD_DIR/string.o $BUILD_DIR/outb.o $BUILD_DIR/cursor.o $BUILD_DIR/terminal.o $BUILD_DIR/kernel.o -lgcc
