...
#link the kernel
i686-elf-gcc -T linker.ld -o $BUILD_DIR/bodos.bin -ffreestanding -O2 -nostdlib $BUILD_DIR/boot.o $BUILD_DIR/string.o $BUILD_DIR/terminal.o $BUILD_DIR/kernel.o -lgcc
